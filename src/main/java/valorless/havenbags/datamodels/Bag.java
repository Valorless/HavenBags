...
public class Bag {
	 ...
	 */
	public Bag(@NotNull String uuid, @NotNull String owner) {
	 ...
	 */
	public Bag(@NotNull String uuid, @NotNull String owner, @NotNull Material material) {
	 ...
	 */
	public Bag clone() {
        Bag copy = new Bag(this.uuid, this.owner);
